//take from "keyestudio Basic Starter V2 Kit for Arduino". I found it on their website.
...
void setup()
{
  ...
  When connected to a specific device, (e.g. bluetooth), the baud rate needs
  to be the same with it.*/
